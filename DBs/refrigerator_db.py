...
class RefrigeratorDB:
    ...
    def __init__(self, db_folder: str = "user_databases"):
        """Initialize the database handler
        
        Args:
            db_folder: Folder to store user databases
        """
    ...
    def get_db_path(self, user_id: int) -> str:
        ...
        """
        return os.path.join(self.db_folder, f"refrigerator_{user_id}.db")
    ...
    def add_item_to_refrigerator(self, user_id: int, item_name: str, 
                                quantity: int = 1, unit: str = 'pieces', 
    ...
    def save_user_info(self, user_id: int, username: str = None, 
